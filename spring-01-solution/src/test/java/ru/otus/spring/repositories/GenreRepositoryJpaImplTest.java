...
class GenreRepositoryJpaImplTest {
    ...
    void shouldFindExpectedGenreById() {
        val optionalActualGenre = genreRepositoryJpa.findById(FIRST_COMMENT_ID);
    ...
    void shouldReturnCorrectBooksListWithAllInfo() {
        ...
        val students = genreRepositoryJpa.findAll();
    ...
    void testSave() {
        ...
        Optional<Genre> optionalActualGenre = genreRepositoryJpa.findById(savedGenre.getId());
